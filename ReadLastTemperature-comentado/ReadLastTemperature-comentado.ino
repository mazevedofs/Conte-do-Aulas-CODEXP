...
#define USE_ETHERNET_SHIELD
  ...
  #error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    #include <SPI.h>
    //#include <Ethernet.h> //nosso shield nao funciona com essa biblioteca
    #include <UIPEthernet.h> //usar essa com nosso  shield
    byte mac[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0xF1, 0x41};
